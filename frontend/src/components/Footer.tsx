        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li><Link href="/predict" className="hover:text-emerald-600 transition-colors">Scan a Job</Link></li>
              <li><Link href="/history" className="hover:text-emerald-600 transition-colors">My History</Link></li>
              <li><Link href="#" className="hover:text-emerald-600 transition-colors">API Documentation</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-500">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:support@jobcheck-ai.com" className="hover:text-emerald-600 transition-colors">support@jobcheck-ai.com</a>
              </li>
              <li className="flex items-center gap-2">
