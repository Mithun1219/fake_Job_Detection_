                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex justify-center mb-10 pt-4">
                        <div className="relative w-48 h-48 border-8 border-slate-100 rounded-full flex items-center justify-center bg-white shadow-inner">
                        ...
                        <div className="text-center z-10">
                            <div className={`text-5xl font-extrabold ${result.label === 'FAKE' ? 'text-red-600' : 'text-green-600'}`}>
                              {result.confidence}%
                            </div>
