        ...
        <div className="relative z-10 container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <AnimatedSection direction="up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-slate-200 text-emerald-700 text-sm font-medium mb-8 shadow-sm">
              ...
              <h1 className="text-5xl md:text-7xl font-bold font-space tracking-tight mb-6 text-slate-900 leading-tight">
                Detect <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-cyan-500">Fake</span> Jobs, 
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                {user ? (
                  ...
                  <>
                    ...
                    <Link 
                      href="/login" 
                      className="px-8 py-4 font-medium text-slate-700 transition-all duration-300 bg-white/70 backdrop-blur-lg rounded-full hover:bg-white hover:text-emerald-700 border border-slate-200 hover:shadow-lg shadow-sm"
                    >
                      Log In
                    </Link>
                  </>
